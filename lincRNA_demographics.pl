#!/usr/bin/perl -w
# count_fasta.pl
# AUTHOR: Andrew Nelson (modified from script by Joseph Fass and Brad Sickler)
...
my $avglengthunrounded = $totalLength/$n;
my $avglength = sprintf("%.0f", $avglengthunrounded);
...
print "Average length:\t$avglength nt\n";
